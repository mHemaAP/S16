...
class TransformerLitModule(LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        print(f'Average Training Loss at end of epoch {self.trainer.current_epoch} = {mean_loss}')
        
        print(f'Learning Rate at end of epoch {self.trainer.current_epoch} = {self.scheduler.get_last_lr()}')
